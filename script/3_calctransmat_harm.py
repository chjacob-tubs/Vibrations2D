...
#path = '/home/julia/testsystems/DAR/def2tzvp_b3lyp_V1V2_CO/'
...
np.save('results_VCI_exciton/VCI_intensities_harm.npy',inten)
np.save('results_VCI_exciton/VCI_frequencies_harm.npy',freqs)
np.save('results_VCI_exciton/VCI_dipolemoments_harm.npy',transm)
