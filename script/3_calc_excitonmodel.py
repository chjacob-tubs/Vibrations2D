...
#path = '/home/julia/testsystems/DKP/def2-SVP/b3lyp'
#path = '/anharm'
...
np.save('results_VCI_exciton/Exciton_cmat_lm.npy', cmat)
np.save('results_VCI_exciton/Exciton_dipolemoments_lm.npy', dipoles)
np.save('results_VCI_exciton/Exciton_dipolemoments_nm.npy', dipoles_norm)
