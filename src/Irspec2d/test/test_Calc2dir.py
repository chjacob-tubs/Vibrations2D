...
@pytest.fixture
def Calc2dir_base_2modes(freqmat_2modes,dipoles_2modes):
    '''
...
@pytest.fixture
def Calc2dir_base_3modes(freqmat_3modes,dipoles_3modes):
    '''
    Sets the testing object. 
    Rounded data is from the GAAP molecule calculated with a 
    def2-TZVP basis set and B3-LYP functional. 
...
def set_dipoles_diff_shape_2modes():
    '''
...
def set_dipoles_diff_shape_3modes():
    '''
    Sets the testing transition dipole moment matrix in the (m,m,3,1) shape. 
    Rounded data is from the GAAP molecule calculated with a 
    def2-TZVP basis set and B3-LYP functional. 
...
def test_calc_nmodes(Calc2dir_base_2modes,Calc2dir_base_3modes):
    '''
...
def test_calc_num_oscill(Calc2dir_base_2modes,Calc2dir_base_3modes):
    '''
...
def test_calc_trans2int(Calc2dir_base_2modes,Calc2dir_base_3modes):
    '''
    Calculates the intensity matrix from the given transition dipole moment matrix 
    and the given frequeny matrix.

    '''
    ints_2modes = [[ 0.00000000e+00,  8.52705311e+02,  4.27354770e+00, 3.29672974e-02,  8.13346534e+00,  8.05664621e-03],
       [-8.52705311e+02,  0.00000000e+00,  7.47169637e-03, 1.48222729e+03,  4.42258245e+00,  2.04639398e+02],
       [-4.27354770e+00, -7.47169637e-03,  0.00000000e+00, 1.16371546e+00,  8.36363705e+02,  7.51923082e+00],
       [-3.29672974e-02, -1.48222729e+03, -1.16371546e+00, 0.00000000e+00,  0.00000000e+00,  4.06075904e-06],
       [-8.13346534e+00, -4.42258245e+00, -8.36363705e+02, 0.00000000e+00,  0.00000000e+00,  1.50953453e-02],
       [-8.05664621e-03, -2.04639398e+02, -7.51923082e+00, -4.06075904e-06, -1.50953453e-02,  0.00000000e+00]]
