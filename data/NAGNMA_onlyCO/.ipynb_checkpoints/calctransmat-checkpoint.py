...
res = LocVib.SNFResults(outname='/home/julia/testsystems/NAGNMA/def2svp_b3lyp_V1V2_CO/snf.out',
                        restartname='/home/julia/testsystems/NAGNMA/def2svp_b3lyp_V1V2_CO/restart', 
                        coordfile='/home/julia/testsystems/NAGNMA/def2svp_b3lyp_V1V2_CO/coord')
res.read()
...
v1.read_np('/home/julia/testsystems/NAGNMA/def2svp_b3lyp_V1V2_CO/V1_g16.npy')
...
dm1 = vib.Dipole(grid)
dm1.read_np('/home/julia/testsystems/NAGNMA/def2svp_b3lyp_V1V2_CO/Dm1_g16.npy')

# Read in anharmonic 2-mode potentials

v2 = vib.Potential(grid, order=2)
v2.read_np('/home/julia/testsystems/NAGNMA/def2svp_b3lyp_V1V2_CO/V2_g16.npy')
...
dm2.read_np('/home/julia/testsystems/NAGNMA/def2svp_b3lyp_V1V2_CO/Dm2_g16.npy')
