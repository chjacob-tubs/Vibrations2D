...
res = LocVib.SNFResults(outname='/home/julia/testsystems/DKP/def2svp_b3lyp_V1V2/snf.out',
                        restartname='/home/julia/testsystems/DKP/def2svp_b3lyp_V1V2/restart', 
                        coordfile='/home/julia/testsystems/DKP/def2svp_b3lyp_V1V2/coord')
res.read()
...
v1.read_np('/home/julia/testsystems/DKP/def2svp_b3lyp_V1V2/V1_g16.npy')
...
dm1 = vib.Dipole(grid)
dm1.read_np('/home/julia/testsystems/DKP/def2svp_b3lyp_V1V2/Dm1_g16.npy')

# Read in anharmonic 2-mode potentials

v2 = vib.Potential(grid, order=2)
v2.read_np('/home/julia/testsystems/DKP/def2svp_b3lyp_V1V2/V2_g16.npy')
...
dm2.read_np('/home/julia/testsystems/DKP/def2svp_b3lyp_V1V2/Dm2_g16.npy')
